...
<div class="col-lg-10 right_panel manage_mem">
    ...
    <div class="row sortable">
        ...
        <input type="hidden"  name="category_id" value="<?php if(isset($category['category_id'])){ echo $page['category_id'];}?>" >
        
         <h3>Category</h3>
         <div class="form-group">
           <label>Category Name</label>
           <input type="text" name="category_name" onblur="check_slug(this.value)" required value="<?php if(isset($page['category_name'])){ echo $page['category_name'];}?>" placeholder="category Name">
         </div>
         <div class="form-group">
           <label>Slug</label>
           <input type="text" name="category_type_slug" required value="<?php if(isset($page['category_type_slug'])){ echo $page['category_type_slug'];}?>" placeholder="slug name">
      ...
      $filtergroup = $this->Common_model->getall('shope_categories', 'category_id', 'desc');
                        ...
                        <td><?= $dataa->category_type_slug; ?></td>
                                ...
                                <td><a href="<?= base_url() ?>category/editcategory/<?= $dataa->category_id; ?>" onclick="return confirm('Are you sure?')"><i class="fa fa-pencil-square-o"></i></a>&nbsp&nbsp<a href="<?= base_url() ?>category/delete_page/<?= $dataa->category_id; ?>" onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i></a>
